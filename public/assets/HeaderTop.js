...
function HeaderTop({ notificationCount = 0 }) {
  ...
  return (
    <div id="header_top" className="header_top">
      <div className="container">
        <div className="hleft">
          <a className="header-brand" href={dashboardLink}>
            {/* <i className="fa fa-graduation-cap brand-logo"></i> */}
             <img style={{background:'#fff',borderRadius:'50%'}} src="./assets/dbs-logo1.png" />
          </a>
          ...
          <div className="dropdown">
            ...
            <a href="/Notifications" className="nav-link icon position-relative">
