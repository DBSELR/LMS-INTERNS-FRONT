...
function AdminLiveClassAttendanceAnalytics() {
  ...
  useEffect(() => {
    const init = async () => {
      try {
        ...
        if (!res.ok) {
          console.error("Failed to fetch live class attendance percent", res.status);
          setLoading(false);
          return;
        }

        const data = await res.json();
        console.log("📊 Live class attendance stats:", data);
        ...
        console.error("❌ Error loading admin live class attendance analytics:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div id="main_content" className="font-muli theme-blush">
      ...
      <HeaderTop />
      <RightSidebar />
      {/* You can keep "Admin" or derive role from token if you want */}
            ...
            <div className="container-fluid">
              ...
              <div className="jumbotron bg-light rounded shadow-sm mb-3 welcome-card dashboard-hero">
                ...
                <p className="text-muted mb-0 dashboard-hero-sub">
                  Batch-wise and course-wise live class attendance with visual
                  breakdown.
                </p>
              </div>
